...
//       })
  ...
  elements: {
    nodes: [
      {
        data: { id: 'cy', name: 'Water Treatment Plant' }
      }, 
      ...
      {
        data: { id: 'core', name: 'Source', parent: 'api' },
        position: { x: 0, y: 0 }
      },
      ...
      {
        data: { id: 'api', name: 'Source', parent: 'cy' }
      },

      {
        data: { id: 'app', name: 'Source' },
    ...
    edges: [
      ...
      { data: { source: 'app', target: 'api', name: 'pump water' }, classes: 'app' },
    ]
  },
